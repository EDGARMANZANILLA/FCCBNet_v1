...
namespace DAP.Foliacion.Negocios
{
    ...
    public class EncriptarCadena
    {
        ...
        /*string cadenaDeIntegridad = datosCompletosObtenidos.Id_nom + " || " + datosCompletosObtenidos.Quincena + " || " + registroSeleccionado.NumeroEmpleado + " || " + registroSeleccionado.Liquido + " || " + folio + " || " + registroSeleccionado.NumBeneficiario;*/
        //string key = "ABCDEFG54669525PQRSTUVWXYZabcdef852846opqrstuvwxyz";

        //Contrasenia SAIG2021
        //SAIG2021 llave
        ...
        public string DesEncriptarCadena(string clave)
        {
            byte[] keyArray;
